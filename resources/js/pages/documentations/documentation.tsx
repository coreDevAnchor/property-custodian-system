...
const importCustodiansSection: DocSection = {
        ...
        ? [
              ...
              ...custodianSections
                  .filter(
                      (s) =>
                          s.id !== 'installation' &&
                          s.id !== 'email-configuration',
                  )
                  .flatMap((s) => {
                      if (s.id === 'employee-management') {
                          return [s, importEmployeesSection];
                      }

                      if (s.id === 'custodian-management') {
                          return [s, importCustodiansSection];
                      }
